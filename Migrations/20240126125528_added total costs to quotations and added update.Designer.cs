...
namespace backEnd.Migrations
{
    ...
    [Migration("20240126125528_added total costs to quotations and added update")]
    partial class addedtotalcoststoquotationsandaddedupdate
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("backEnd.Models.Hotels", b =>
                {
                    ...
                    b.Property<string>("Actual_rate")
                        .HasColumnType("nvarchar(max)")
                        .HasAnnotation("Relational:JsonPropertyName", "actual_rate");

                    b.Property<string>("Average_rate")
                        .HasColumnType("nvarchar(max)")
                        .HasAnnotation("Relational:JsonPropertyName", "average_rate");
            ...
            modelBuilder.Entity("backEnd.Models.User", b =>
                {
                    ...
                    b.HasAnnotation("Relational:JsonPropertyName", "hotelApprovals");
                });
