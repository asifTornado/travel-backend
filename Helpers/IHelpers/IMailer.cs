...
{
    Task EmailRequest(Request request, string recipient, User auditor, string type, ControllerContext controllerContext, User user = null);
    ...
    Task SendExpenseReport(string accountsMail, string filename, Request request, string auditorMail = null);
